...
const providerIcons: Record<string, string> = {
  ...
  apple: `<svg viewBox="0 0 24 24" width="20" height="20"><path fill="#000" d="M17.05 20.28c-.98.95-2.05.88-3.08.4-1.09-.5-2.08-.48-3.24 0-1.44.62-2.2.44-3.06-.4C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"/></svg>`,
}
</script>
...
.modal-header h3 { font-size: 1.25rem; font-weight: 700; margin: 0; color: #1a1a2e; }
.close-btn { background: none; border: none; font-size: 1.5rem; cursor: pointer; color: #666; padding: 0.25rem; }

.error-msg {
  background: #fef2f2; color: #dc2626; padding: 0.75rem; border-radius: 8px;
  font-size: 0.875rem; margin-bottom: 1rem; border: 1px solid #fecaca;
}

.form-section { display: flex; flex-direction: column; gap: 1rem; }
.input-group { display: flex; flex-direction: column; gap: 0.375rem; }
.input-group label { font-size: 0.8rem; font-weight: 600; color: #374151; }
.input-group input {
  padding: 0.75rem; border: 1.5px solid #e5e7eb; border-radius: 10px;
...
.primary-btn {
  ...
  padding: 0.85rem; border: none; border-radius: 10px; font-size: 1rem;
...
.social-section { display: flex; flex-direction: column; gap: 0.75rem; }
.social-btn {
...
.social-btn:not(:disabled):hover { background: #f9fafb; }
.provider-icon { display: flex; align-items: center; }

.switch-mode {
  text-align: center; margin-top: 1.5rem; font-size: 0.875rem; color: #6b7280;
}
.switch-mode a { color: #6366f1; font-weight: 600; text-decoration: none; }
