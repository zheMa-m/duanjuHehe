...
const { t } = useI18n()
definePageMeta({
  title: '智能问卷 · Premium Activated (Android)',
  alias: ['/starpath/订阅成功-安卓'],
})
...
const provider = computed(() => (route.query.provider as string) || 'Google Pay')
  ...
  <div class="starpath-page" data-biz="starpath">
    ...
    <div class="starpath-frame pt-safe-top flex flex-col items-center justify-center min-h-screen px-4">
      <div class="relative z-10 flex flex-col items-center w-full max-w-[360px]">
        ...
        >
          <img :src="figmaAssets['google-play-badge']" alt="Google Play" class="h-[32px]">
        </a>
