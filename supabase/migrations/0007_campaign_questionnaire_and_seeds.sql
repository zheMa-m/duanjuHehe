-- ============================================================================
-- 0007 增量：问卷模块表 + campaign_orders + 种子数据
--
-- 背景：0003 迁移原始推送时仅含 campaigns + campaign_registrations。
--      后续追加的问卷模块表、campaign_orders、种子数据均未推送到远端。
--      此文件同步所有 0003_campaign.sql 中未执行的内容。
--
-- 前置依赖：0001_core + 0002_iap + campaigns 表（已执行）
-- ============================================================================

BEGIN;

-- ╔══════════════════════════════════════════════════════════════════════════╗
-- ║  1. questionnaire_sessions — 问卷会话主表                                  ║
-- ╚══════════════════════════════════════════════════════════════════════════╝
...
-- ╔══════════════════════════════════════════════════════════════════════════╗
-- ║  2. questionnaire_answers — 答案事件流（append-only）                      ║
-- ╚══════════════════════════════════════════════════════════════════════════╝
...
-- ╔══════════════════════════════════════════════════════════════════════════╗
-- ║  6. 种子数据：StarPath AI 占星活动（含完整智能问卷模板）                     ║
-- ╚══════════════════════════════════════════════════════════════════════════╝
